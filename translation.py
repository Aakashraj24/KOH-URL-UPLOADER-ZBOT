...
Myself KOH Aakash and I'm not Bewafa 
...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thank you <a href='https://t.me/koh_premium_bots'>**koh_Agent**</a> for helping us in this journey ❤️"
...
Contact ADMIN if any error occurs @koh_premium_bots"""
    ...
    KOH_START_TEXT = """𝙷𝚎𝚕𝚕𝚘 𝗕𝗲𝘄𝗮𝗳𝗮 {},

𝗬𝗼𝘂 𝗺𝘂𝘀𝘁 𝗯𝗲 𝗮𝗻 𝗔𝘂𝘁𝗵𝗲𝗻𝘁𝗶𝗰 𝗨𝘀𝗲𝗿 𝘁𝗼 𝘂𝘀𝗲 𝗺𝗲.
The koh_Agent has not allowed me to upload files from the urls which is send by an unAuthorised member.

Please contact my Developer to be an authorised user ! 
"""
    KOH_DEVELOPER_TEXT = """▍║▍▏║ Hello Dear ADMIN ║▍▏║▍
⭑┗┫⦀⦙ {} ⦙⦀┣┛⭑
